<template>
  <div id="animated-arcade">
    ...
    <div v-if="showAnimation" class="animation-container">
      <ul class="machines">
        <ArcadeMachine v-for="index in [1, 2, 3]" v-bind:key="index" :type="index" />
      </ul>
...
.toggle-animation {
  ...
  transition: all 0.25s cubic-bezier(0.31, -0.105, 0.43, 1.4), line-height 1ms;
  z-index: 999;
  animation: jelly 1s linear both;
}
